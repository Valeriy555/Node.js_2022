    ...
    sendMail: async (userMail = '', emailAction = '', context = {}) => {
        ...
        const hbsOptions = {
            viewEngine: {
                extname: '.hbs',
                defaultLayout: 'main',
                layoutsDir: path.join(process.cwd(),'lesson_8', 'email-templates', 'layouts'),
                partialsDir: path.join(process.cwd(),'lesson_8', 'email-templates', 'partials'),
            },
            viewPath: path.join(process.cwd(),'lesson_8', 'email-templates', 'views'),
            extName: '.hbs',
        }
